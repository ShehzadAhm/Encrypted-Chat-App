...
/*
 * RSA class will generate RSA key pair and save in files locally.
*/
...
public class RSA 
{
    ...
    Key privateKey;
		...
		/*
		 * main method will instantiate an object of RSA class and call the createRSA method.
		 */
		...
		// ============ Generating key pair =======
		/*
		 * createRSA method will create RSA key pair. The keys will be saved as object in two separate files.
        */
		...
		/*
		 * serializeToFile method will create an ObjectOutput Stream and save the elements of key pairs into files locally.
		 */
