...
public class Client 
{
    ...
    /*
     * The main method
     * Creates an instance of Client class with provided server address and TCP port to establish the socket conenction.
     * @param 
    ...
    */
    ...
    private byte[] encryptMessage(String s) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException,                                                           InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException
    {
        cipher2 = null;
     ...
     * @param byte[] data takes the byte array of encrypted message as input. Returns plain text.
     */
    ...
    public void closeSocket() 
    {
         ...
         * Will read the RSA public key from the file "public.key" on the same directory to encrypt the AES key.
         * 
         */
