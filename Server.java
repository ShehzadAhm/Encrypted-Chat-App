...
{	
	...
	/*
	 * the main method will instantiate RSA object to create RSA public - private key pair and save it as "public.key" and "private.key" files in the same directory.
	...
	/*
	 * the start method: Will create a server socket listening for connections on TCP port 8002.
	...
	void start() throws IOException
	{
		 ...
		 * The thread will access the input and output streams of the socket to receive and send messages from client.
	    */
	   ...
	   * decryptAESKey method : will use RSA private key from the public - private key pair to decipher the AES key encrypted 
	   using public key and sent by the client.
	   * @param byte[] encryptedData : The encrypted key as byte array.
	   */
	 ...
	 * decryptMessage method: Deciphers the encrypted message received from the client.
	...
	private void decryptMessage(byte[] encryptedMessage) 
	{
		 ...
		 * encryptMessage method: Takes the message string as input and encrypts it.
		 */
	 ...
	 * readPrivateKeyFromFile method : reads the RSA private key from private.key file saved in same directory.
